package ch.jvi.magpie.command.domain.transfer.command

import ch.jvi.magpie.command.api.Command
import ch.jvi.magpie.command.api.CreationCommand
import ch.jvi.magpie.command.domain.api.IDProvider
