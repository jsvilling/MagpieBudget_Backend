package ch.jvi.magpie.domain.command.domain.transfer.persistence.store
...
import ch.jvi.magpie.domain.command.domain.transfer.persistence.repository.TransferCreationCommandRepository
import ch.jvi.magpie.domain.command.domain.transfer.persistence.repository.UpdateTransferCommandRepository
