package ch.jvi.magpie.domain.command.domain.transfer.command

import ch.jvi.magpie.domain.command.api.Command
import ch.jvi.magpie.domain.command.api.CreationCommand
import ch.jvi.magpie.domain.command.domain.api.IDProvider
